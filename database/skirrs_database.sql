...
CREATE TABLE IF NOT EXISTS `rides_offered` (
  ...
  `srcltt` float(10,6) NOT NULL COMMENT 'source lattitude',
  `srclng` float(10,6) NOT NULL COMMENT 'source longitude',
  `destltt` float(10,6) NOT NULL COMMENT 'destination lattitude',
  `destlng` float(10,6) NOT NULL COMMENT 'destination longitude',
